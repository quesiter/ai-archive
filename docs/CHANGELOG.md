...
服务端与 Web 升级为 `V2.1.2`；Chrome 插件保持 `V2.1.1`，Windows/macOS 同步代理和共享协议保持 `V2.1.0`，本次不重新发布客户端安装包。

发布包：`release/ai-conversation-archive-nas-V2.1.2-clean-install.tar.gz`。
